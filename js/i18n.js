...
const TRANSLATIONS = {
  pl: {
    ...
    'team-nawrocki-bio1': 'Posiada bogate doświadczenie zarówno w kompleksowej obsłudze prawnej przedsiębiorców oraz grup kapitałowych, jak również w świadczeniu pomocy prawnej na rzecz klientów indywidualnych. Nie tylko doradza w rozwiązaniu problemów, lecz również rozwiązuje je za nich.',
    'team-nawrocki-bio2': 'Po kilku latach zbierania praktyki w kancelarii indywidualnej zmienił profil aktywności, realizując stałą obsługę prawną dużego przedsiębiorstwa, gdzie z czasem zaczął odpowiadać również za stronę biznesową. Ukończył studia MBA.',
    'team-nawrocki-tag1': 'Prawo żywnościowe',
    'team-nawrocki-tag2': 'Odszkodowania i zadośćuczynienia',
    'team-nawrocki-tag3': 'Pomoc konsumentom',
    'team-slania-role': 'Radca Prawny · nr wpisu KT-4082',
    'team-slania-bio1': 'Od kilkunastu lat prowadzi stałą obsługę gospodarczą podmiotów z branży medycznej, gdzie od lat pełni również funkcje prokurenta, łącząc perspektywę biznesową ze znajomością prawa.',
    'team-slania-bio2': 'Przez lata pracy z klientami indywidualnymi i przedsiębiorcami wypracował podejście oparte na rzetelnej analizie i jasnej, pozbawionej zbędnego żargonu komunikacji skupionej na oczekiwanym przez klientów rezultacie.',
    ...
    'cf-rodo-text':          'Wyrażam zgodę na przetwarzanie moich danych osobowych przez KNS Kancelaria Radców Prawnych w celu odpowiedzi na moje zapytanie, zgodnie z <a href="polityka-prywatnosci.html" target="_blank" rel="noopener">Polityką prywatności</a>. <span aria-hidden="true">*</span>',
  ...
  en: {
    ...
    'team-nawrocki-bio1': 'He has extensive experience in providing comprehensive legal services to entrepreneurs and capital groups, as well as legal assistance to individual clients. He does not merely advise on solving problems — he solves them.',
    'team-nawrocki-bio2': 'After several years of practice at an individual law firm, he shifted his focus to providing ongoing legal support for a large enterprise, where he gradually took on responsibility for the business side as well. He holds an MBA degree.',
    'team-nawrocki-tag1': 'Food Law',
    'team-nawrocki-tag2': 'Compensation & Damages',
    'team-nawrocki-tag3': 'Consumer Protection',
    'team-slania-role': 'Legal Counsel · bar no. KT-4082',
    'team-slania-bio1': 'For over a decade he has provided ongoing business legal services to entities in the medical sector, where he has also long served as a commercial proxy (prokurent), combining a business perspective with legal expertise.',
    'team-slania-bio2': 'Over years of working with individual clients and entrepreneurs he has developed an approach based on thorough analysis and clear, jargon-free communication focused on the results clients expect.',
    ...
    'cf-rodo-text':          'I consent to the processing of my personal data by KNS Law Firm for the purpose of responding to my enquiry, in accordance with our <a href="polityka-prywatnosci.html" target="_blank" rel="noopener">Privacy Policy</a>. <span aria-hidden="true">*</span>',
